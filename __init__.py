...
if __name__ == '__main__':
    ...
    # base_topic = sys.argv[5]
    # timeout = int(sys.argv[6])
    timeout = 60
    # selectedLogLevel = logLevelMap[sys.argv[7]]
    ...
    p_element = driver.find_element_by_xpath('//*[@id="app"]')
    ...
    while True:
        ...
        for key in monitor_data:
            ...
            mqtt_client.publish("alphaess/" + key, monitor_data[key])
